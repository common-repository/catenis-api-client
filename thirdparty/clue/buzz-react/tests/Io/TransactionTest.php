...
use Catenis\WP\Clue\React\Buzz\Io\Transaction;
use Catenis\WP\Clue\React\Buzz\Message\ResponseException;
use Catenis\WP\PHPUnit\Framework\MockObject\MockObject;
...
class TransactionTest extends TestCase
{
    public function testWithOptionsReturnsNewInstanceWithChangedOption()
    {
        ...
        $this->assertInstanceOf('Catenis\WP\Clue\React\Buzz\Io\Transaction', $new);
    ...
    public function testCancelBufferingResponseWillCloseStreamAndReject()
    {
        ...
        $stream = $this->getMockBuilder('Catenis\WP\React\Stream\ReadableStreamInterface')->getMock();
    ...
    public function testReceivingStreamingBodyWillResolveWithStreamingResponseIfStreamingIsEnabled()
    {
        ...
        $request = $this->getMockBuilder('Psr\Http\Message\RequestInterface')->getMock();
        $response = $messageFactory->response(1.0, 200, 'OK', array(), $this->getMockBuilder('Catenis\WP\React\Stream\ReadableStreamInterface')->getMock());
    ...
    public function testCustomRedirectResponseCode333WillFollowLocationHeaderAndSendRedirectedRequest()
    {
        ...
        $sender->expects($this->exactly(2))->method('send')->withConsecutive($requestOriginal, $requestRedirected)->willReturnOnConsecutiveCalls(
            ...
            new \Catenis\WP\React\Promise\Promise(function () { })
        );
    ...
    public function testCancelTransactionWillCancelRequest()
    {
        ...
        $pending = new \Catenis\WP\React\Promise\Promise(function () { }, $this->expectCallableOnce());
    ...
    public function testCancelTransactionWillCancelRedirectedRequestAgain()
    {
        ...
        $second = new \Catenis\WP\React\Promise\Promise(function () { }, $this->expectCallableOnce());
    ...
    public function testTimeoutExplicitOptionWillThrowException()
    {
        ...
        // mock sender to resolve promise with the given $response in response to the given $request
        $sender = $this->getMockBuilder('Catenis\WP\Clue\React\Buzz\Io\Sender')->disableOriginalConstructor()->getMock();
        $sender->expects($this->once())->method('send')->with($this->equalTo($request))->willReturn(Promise\resolve($response));
    ...
    {
        return $this->getMockBuilder('Catenis\WP\Clue\React\Buzz\Io\Sender')->disableOriginalConstructor()->getMock();
    }
