...
use Catenis\WP\RingCentral\Psr7\Uri;
...
class BrowserTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->sender = $this->getMockBuilder('Catenis\WP\Clue\React\Buzz\Io\Transaction')->disableOriginalConstructor()->getMock();
    ...
    public function testWithBase()
    {
        ...
        $this->assertInstanceOf('Catenis\WP\Clue\React\Buzz\Browser', $browser);
