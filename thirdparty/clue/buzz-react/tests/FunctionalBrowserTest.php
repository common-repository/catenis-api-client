...
use Catenis\WP\Psr\Http\Message\ServerRequestInterface;
use Catenis\WP\React\EventLoop\Factory;
use Catenis\WP\React\Http\Response;
use Catenis\WP\React\Http\StreamingServer;
...
class FunctionalBrowserTest extends TestCase
{
    ...
    public function testPostStreamChunked()
    {
        ...
        $socket = new \Catenis\WP\React\Socket\Server(0, $this->loop);
