...
class MessageFactoryTest extends TestCase
{
    ...
    public function testBodyString()
    {
        ...
        $this->assertNotInstanceOf('Catenis\WP\React\Stream\ReadableStreamInterface', $body);
    ...
    public function testBodyReadableStream()
    {
        ...
        $this->assertInstanceOf('Psr\Http\Message\StreamInterface', $body);
        $this->assertInstanceOf('Catenis\WP\React\Stream\ReadableStreamInterface', $body);
