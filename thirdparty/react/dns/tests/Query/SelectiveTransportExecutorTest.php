...
class SelectiveTransportExecutorTest extends TestCase
{
    ...
    {
        $this->datagram = $this->getMockBuilder('Catenis\WP\React\Dns\Query\ExecutorInterface')->getMock();
        $this->stream = $this->getMockBuilder('Catenis\WP\React\Dns\Query\ExecutorInterface')->getMock();
