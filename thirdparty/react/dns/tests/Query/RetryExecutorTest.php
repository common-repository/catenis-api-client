...
use Catenis\WP\React\Dns\Query\TimeoutException;
use Catenis\WP\React\Dns\Model\Record;
...
{
    /**
    * @covers Catenis\WP\React\Dns\Query\RetryExecutor
    * @test
    */
    public function queryShouldDelegateToDecoratedExecutor()
    {
        ...
        $executor
            ->expects($this->once())
            ->method('query')
            ->with($this->isInstanceOf('Catenis\WP\React\Dns\Query\Query'))
    ...
    */
    public function queryShouldRetryQueryOnTimeout()
    {
        ...
        $callback
            ->expects($this->once())
            ->method('__invoke')
            ->with($this->isInstanceOf('Catenis\WP\React\Dns\Model\Message'));
    ...
    */
    ...
    {
        return $this->getMockBuilder('Catenis\WP\React\Dns\Query\ExecutorInterface')->getMock();
    }

    protected function createPromiseMock()
    {
        return $this->getMockBuilder('Catenis\WP\React\Promise\PromiseInterface')->getMock();
    }
