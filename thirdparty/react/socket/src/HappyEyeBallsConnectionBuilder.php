...
use Catenis\WP\React\Dns\Resolver\ResolverInterface;
use Catenis\WP\React\EventLoop\LoopInterface;
use Catenis\WP\React\EventLoop\TimerInterface;
...
final class HappyEyeBallsConnectionBuilder
{
     ...
     * @return \Catenis\WP\React\Promise\PromiseInterface<string[],\Exception> Returns a promise
