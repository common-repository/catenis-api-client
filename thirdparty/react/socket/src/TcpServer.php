...
namespace Catenis\WP\React\Socket;

use Catenis\WP\Evenement\EventEmitter;
 ...
 *
 * ```php
 * $server = new Catenis\WP\React\Socket\TcpServer(8080, $loop);
 * ```
 *
...
final class TcpServer extends EventEmitter implements ServerInterface
{
     ...
     *
     * ```php
     * $server = new Catenis\WP\React\Socket\TcpServer(0, $loop);
     ...
     *
     * ```php
     * $server = new Catenis\WP\React\Socket\TcpServer('192.168.0.1:8080', $loop);
     * ```
     *
     ...
     *
     * ```php
     * $server = new Catenis\WP\React\Socket\TcpServer('[::1]:8080', $loop);
     * ```
     *
     ...
     * $server = new Catenis\WP\React\Socket\TcpServer('127.0.0.1', $loop);
     * ```
     *
     ...
     *
     * ```php
     * $first = new Catenis\WP\React\Socket\TcpServer(8080, $loop);
     *
     * // throws RuntimeException because port is already in use
     * $second = new Catenis\WP\React\Socket\TcpServer(8080, $loop);
     * ```
     *
     ...
     *
     * ```php
     * $server = new Catenis\WP\React\Socket\TcpServer('[::1]:8080', $loop, array(
     *     'backlog' => 200,
     *     'so_reuseport' => true,
     *     'ipv6_v6only' => true
     * ));
