...
class FunctionTimeoutTest extends TestCase
{
    ...
    {
        $promise = $this->getMockBuilder('Catenis\WP\React\Promise\PromiseInterface')->getMock();
    ...
    {
        $cancellable = $this->getMockBuilder('Catenis\WP\React\Promise\CancellablePromiseInterface')->getMock();
        $cancellable->expects($this->once())->method('cancel');

        $promise = $this->getMockBuilder('Catenis\WP\React\Promise\CancellablePromiseInterface')->getMock();
    ...
    {
        $promise = new \Catenis\WP\React\Promise\Promise(function () { });

        $loop = $this->getMockBuilder('Catenis\WP\React\EventLoop\LoopInterface')->getMock();

        $timer = $this->getMockBuilder('Catenis\WP\React\EventLoop\Timer\TimerInterface')->getMock();
    ...
    {
        $promise = new \Catenis\WP\React\Promise\Promise(function ($resolve) { $resolve(true); });
    ...
    {
        $promise = new \Catenis\WP\React\Promise\Promise(function () { }, $this->expectCallableOnce());
    ...
    {
        $promise = new \Catenis\WP\React\Promise\Promise(function () { }, function ($resolve, $reject) { $reject(); });
    ...
    {
        $promise = new \Catenis\WP\React\Promise\Promise(function () { }, function ($resolve, $reject) { $resolve(); });
