...
use Catenis\WP\RingCentral\Psr7\FnStream;
use Catenis\WP\RingCentral\Psr7\NoSeekStream;
...
class FunctionsTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $s = $this->getMockBuilder('Catenis\WP\RingCentral\Psr7\Stream')
    ...
    {
        $this->assertInstanceOf('Catenis\WP\RingCentral\Psr7\Uri', Psr7\uri_for('/foo'));
        $this->assertInstanceOf(
            'Catenis\WP\RingCentral\Psr7\Uri',
    ...
    public function testCreatesWithFactory()
    {
        ...
        $this->assertInstanceOf('Catenis\WP\RingCentral\Psr7\Stream', $stream);
    ...
    {
        $s = Psr7\stream_for();
        $this->assertInstanceOf('Catenis\WP\RingCentral\Psr7\Stream', $s);
    }
    ...
    public function testCanCreateIteratorBasedStream()
    {
        ...
        $p = Psr7\stream_for($a);
        $this->assertInstanceOf('Catenis\WP\RingCentral\Psr7\PumpStream', $p);
