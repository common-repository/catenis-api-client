...
use Catenis\WP\RingCentral\Psr7\CachingStream;

/**
 * @covers Catenis\WP\RingCentral\Psr7\CachingStream
 */
class CachingStreamTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testRewindUsesSeek()
    {
        ...
        $d = $this->getMockBuilder('Catenis\WP\RingCentral\Psr7\CachingStream')
